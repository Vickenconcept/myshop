<!-- navbar -->
<nav class="flex flex-col md:flex-row md:justify-between bg-white px-1 fixed top-0 w-full z-20 border-b border-b-gray-200">
        ...
        <ul class="flex flex-col md:flex-row justify-between">
            ...
            <div>
                <button id="dropdownHoverButton2" data-dropdown-toggle="dropdownHover2" data-dropdown-trigger="hover" class="text-black font-medium  p-5  text-center inline-flex items-center" type="button">
                    Product <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg></button>
                <!-- Dropdown menu -->
            ...
            <div>
                <button id="dropdownHoverButton2" data-dropdown-toggle="dropdownHover2" data-dropdown-trigger="hover" class="text-black font-medium  p-5  text-center inline-flex items-center" type="button">
                    Shop <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg></button>
                <!-- Dropdown menu -->
                <div id="dropdownHover2" class="z-20 hidden divide-y divide-gray-100 shadow dark:bg-gray-700 bg-white w-full transition-y ease-out duration-300">
            ...
            <div>
                <button id="dropdownHoverButton2" data-dropdown-toggle="dropdownHover2" data-dropdown-trigger="hover" class="text-black font-medium  p-5  text-center inline-flex items-center" type="button">
                    Blog <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg></button>
                <!-- Dropdown menu -->
                <div id="dropdownHover2" class="z-20 hidden divide-y divide-gray-100 shadow dark:bg-gray-700 bg-white w-full transition-y ease-out duration-300">
            ...
            <div>
                <a href="{{ route('landing.contact') }}" class="text-black font-medium  p-5  text-center inline-flex items-center" type="button">
                    Contact us <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg></a>
            </div>
        </ul>
