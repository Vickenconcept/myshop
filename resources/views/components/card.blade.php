    ...
    <div class="px-3">
        ...
        <div class="flex flex-row justify-between">
            ...
            <div x-data="{ toggle: false } " class="{{ request()->routeIs('products.index') ? '' : 'hidden' }}">
                <button @click="toggle = !toggle" x-bind:class="{ 'bg-blue-500': toggle, 'bg-gray-300': !toggle }" class=" shadow relative inline-flex items-center h-4 rounded-full w-8 transition-colors duration-200 focus:outline-none">
