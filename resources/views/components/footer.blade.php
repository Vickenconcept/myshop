<footer class="bg-gray-100 mt-10">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-20">
        ...
        <div class=" p-4 ">
            <h1 class=" text-black font-normal text-2xl mb-8 ">Quick Contact</h1>
            <p class="text-gray-500 pr-20 mb-5">121 King St, Melbourne VIC 3000,Australia</p>
            <button class="bg-tranpsrent border-[1px] border-gray-500 text-gray-500 px-16 py-2 rounded-full"> <i class='bx bx-phone-outgoing text-red-400 text-2xl'></i> (888) 123 4567</button>
        </div>
        <div class=" p-4 ">
            <h1 class=" text-black font-normal text-2xl mb-8 ">Follow Us</h1>
            <div>
                <i class='bx bxl-facebook-circle text-[3rem] text-gray-900 mx-2'></i>
    ...
    <p class="border-t-[0.5px] border-gray-500 py-5 text-gray-500 text-center text-xl">Designed by : <span class="font-semibold text-black"> Wpignite</span></p>
</footer>