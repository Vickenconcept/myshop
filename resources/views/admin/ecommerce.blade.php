<x-admin-layout>
    ...
    <!-- strat content -->
    <div class="flex-1 p-6  bg-white text-gray-700">
        ...
        <div class="grid grid-cols-3 lg:grid-cols-1 gap-5">
            ...
            <div class="card col-span-1">
                ...
                <div class="card-body h-full flex flex-col justify-between">
                    ...
                    <div>
                        <h1 class="text-lg font-semibold tracking-wide">Congratulations Moe!</h1>
                    ...
                    <div class="flex flex-row mt-10 items-end">
                        ...
                        <div class="flex-1">
                            <h1 class="font-extrabold text-4xl text-blue-700">$89k</h1>
                        ...
                        <div class="flex-1 ml-10 w-32 h-32 lg:w-auto lg:h-auto overflow-hidden bg-red-600">
                            <img class="object-cover " src="{{ cloudinary_url('Shoe-hero_dybi6m', []) }}">
                        </div>
            ...
            <div class="card p-0 overflow-hidden col-span-2 lg:col-span-1 flex flex-row lg:flex-col">
                ...
                <div class="border-r border-gray-200 w-2/3 lg:w-full lg:mb-5">
                    ...
                    <div class="p-5 flex flex-row flex-wrap justify-between items-center">
                        <h2 class="font-normal text-lg">Order Summary</h2>
                ...
                <div class="w-1/3 lg:w-full">
                    ...
                    <div class="p-5 border-b border-gray-200">
                        <h2 class="font-normal text-lg mb-6">Sales History</h2>
                    ...
                    <!-- bottom -->
                    <div class="p-5">
                        <h2 class="font-normal text-lg mb-2">Sales History</h2>
                        <strong class="text-blue-700 font-extrabold text-xl">$82,950.96</strong>

                        <div class="bg-gray-300 h-2 rounded-full mt-2 relative">
                            <div class="rounded-full bg-blue-500 h-full w-3/4 shadow-md"></div>
                        </div>
                    </div>
                    <!-- end bottom -->
        ...
        <div class="grid grid-cols-2 lg:grid-cols-1 gap-5 mt-5">
                            ...
                            <tr class="">
                                <td class="py-4 text-sm text-gray-600 flex flex-row items-center text-left">
                                    <div class="w-8 h-8 overflow-hidden mr-3">
                                        <img src="{{ cloudinary_url('Shoe-hero_dybi6m', []) }}" class="object-cover">
                                    </div>
                                    Sneakers and Tennis
                                </td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="font-normal text-lg mb-10">Recent Orders</h2>
