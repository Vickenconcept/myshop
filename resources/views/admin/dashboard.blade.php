...
<div class="mt-6 grid grid-cols-2 gap-6 xl:grid-cols-1">
    ...
    <!-- update section -->
    <div class="card bg-blue-700 border-blue-700 shadow-md text-white">
        ...
        <div class="grid grid-cols-2 gap-6 h-full">
            ...
            <div class="card">
                <div class="py-3 px-4 flex flex-row justify-between">
                    ...
                    <div class="bg-blue-700 text-blue-700 border-blue-700 border w-10 h-10 rounded-full flex justify-center items-center">
...
<!-- end quick Info -->
        ...
        <!-- <div class="   my-20 flex justify-center">
            <form class="bg-white shadow-md rounded  pt-6 w-[450px] pb-8 mb-4 px-10" method="post" action="{{ route('product.store') }}">
                @csrf
                <div class="mb-4 ">
                    <label class="block text-gray-500 text-sm font-normal mb-2" for="name">
                        Name
                    </label>
                    <input value="{{ old('productName') }}"  name="name" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-500 text-sm leading-tight focus:outline-none focus:shadow-sm-outline" id="image" type="text" placeholder="Enter image URL">
                </div>
                <div class="mb-4 ">
                    <label class="block text-gray-500 text-sm font-normal mb-2" for="image">
                        Image
                    </label>
                    <input value="{{ old('image') }}"  name="image" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-500 text-sm leading-tight focus:outline-none focus:shadow-sm-outline" id="image" type="text" placeholder="Enter image URL">
                </div>
                <div class="mb-4 ">
                    <label class="block text-gray-500 text-sm font-normal mb-2" for="description">
                        Description
                    </label>
                    <textarea value="{{ old('description') }}"  name="description" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-500 text-sm leading-tight focus:outline-none focus:shadow-sm-outline" id="description" placeholder="Enter description"></textarea>
                </div>
                <div class="mb-6 ">
                    <label class="block text-gray-500 text-sm font-normal mb-2" for="price">
                        Price
                    </label>
                    <input value="{{ old('price') }}"  name=" price" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-500 text-sm leading-tight focus:outline-none focus:shadow-outline" id="price" type="number" placeholder="Enter price">
                </div>
                <div class="flex items-center justify-center">
                    <button class="bg-red-400 w-full hover:bg-red-700 text-white font-normal py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                        Submit
                    </button>
                </div>
            </form> -->
